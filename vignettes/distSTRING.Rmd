...
[muscle](https://www.ebi.ac.uk/Tools/msa/muscle/) or the R package [`msa`](https://bioconductor.org/packages/release/bioc/html/msa.html).
...
[`distSTRING`](http://bioconductor.org/packages/release/bioc/html/distSTRING.html)
...
## Calculating synonymous (Ks) and nonsynonymous (Ka) substitutions (`dnastring2kaks()`)
...
The window plots are constructed with the R package [`ggplot2`](https://cran.r-project.org/web/packages/ggplot2/index.html).
